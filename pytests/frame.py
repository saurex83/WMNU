...
META_S = struct.Struct('< H b b B B B B H H B H H B B H B')
...
class Frame():
    ...
    def parse(self, data):
        ...
        self.META['TS'] = meta[3]
        self.META['CH'] = meta[4]
        self.META['ACK'] = meta[5]
        self.META['PID'] = meta[6]
        self.META['NDST'] = meta[7]
        self.META['NSRC'] = meta[8]
        self.META['ETX'] = meta[9]
        self.META['FDST'] = meta[10]
        self.META['FSRC'] = meta[11]
        self.META['IPP'] = meta[12]
        self.META['TX_METHOD'] = meta[13]
        self.META['SEND_TIME'] = meta[14]
        self.LEN = meta[15]
